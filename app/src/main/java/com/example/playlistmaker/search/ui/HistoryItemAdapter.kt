...
class HistoryItemAdapter(
    ...
    private var historyList = listOf<Track>()

    fun updateData(newSearchHistory: List<Track>) {
        historyList = newSearchHistory
    ...
    override fun onBindViewHolder(holder: HistoryItemViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { onClick(historyList[position]) }
    }
}